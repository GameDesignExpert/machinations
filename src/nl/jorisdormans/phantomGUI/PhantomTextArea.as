package nl.jorisdormans.phantomGUI 
{
	...
	public class PhantomTextArea extends PhantomControl
	{
		...
		public function PhantomTextArea(caption:String, parent:DisplayObjectContainer, x:Number, y:Number, width:Number = 88, height:Number = 24, showing:Boolean = true, enabled:Boolean = true) 
		{
		...
		public function setFont(fontName:String, size:Number):void {
			_textField.defaultTextFormat.font = fontName;
			_textField.defaultTextFormat.size = size;
