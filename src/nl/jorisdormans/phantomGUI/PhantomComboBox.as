package nl.jorisdormans.phantomGUI 
{
	...
	public class PhantomComboBox extends PhantomEditBox
	{
		...
		public function PhantomComboBox(caption:String, parent:DisplayObjectContainer, stage:Stage, x:Number, y:Number, width:Number = 88, height:Number = 24, showing:Boolean = true, enabled:Boolean = true) 
		{
